...
import { Lock, UserCheck, KeyRound, AlertCircle } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

export const AdminLoginPage: React.FC = () => {
  const { loginAdmin } = useAuth();
  const [email, setEmail] = useState('admin@elegancehair.dz');
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-12 font-sans">
      <div className="w-full max-w-md bg-white p-8 rounded-3xl border border-neutral-200 shadow-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-serif font-extrabold text-neutral-900">
            Espace Administration
          </h1>
          <p className="text-xs text-neutral-500">
            Connectez-vous pour gérer les produits, commandes et stocks Élégance Hair.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="admin@elegancehair.dz"
